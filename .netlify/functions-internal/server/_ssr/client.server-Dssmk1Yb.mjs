...
//#region node_modules/.nitro/vite/services/ssr/assets/client.server-Dssmk1Yb.js
...
function createSupabaseAdminClient() {
	...
	const SUPABASE_KEY = process.env["SUPABASE_SERVICE_ROLE_KEY"] || "sb_secret_-FKIqBYNGL5wKnQOVat9Cw_Oewns_nR";
